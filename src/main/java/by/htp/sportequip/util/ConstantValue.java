...
public final class ConstantValue {
	...
	public static final String SQL_STATEMENT_SELECT_EQUIP = "select eq.id_equip, n.value, eq.title, eq.price, eq.type, eq.url, eq.rentStatus  from equipment eq INNER JOIN nameOfProduct n ON eq.id_name = n.id_name where rentStatus='true'";
	public static final String SQL_STATEMENT_SELECT_EQUIP_TYPE = "select eq.id_equip, n.value, eq.title, eq.price, eq.type, eq.url, eq.rentStatus  from equipment eq INNER JOIN nameOfProduct n ON eq.id_name = n.id_name where eq.type = ? &&  rentStatus='true'";
	public static final String SQL_STATEMENT_SELECT_EQUIP_NAME = "select eq.id_equip, n.value, eq.title, eq.price, eq.type, eq.url, eq.rentStatus  from equipment eq INNER JOIN nameOfProduct n ON eq.id_name = n.id_name where n.value = ? &&  rentStatus='true' ";
}